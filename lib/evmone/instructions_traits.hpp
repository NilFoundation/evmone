...
constexpr inline GasCostTable gas_costs = []() noexcept {
    ...
    table[EVMC_FRONTIER][OP_MLOAD8] = 3;
    table[EVMC_FRONTIER][OP_MLOAD16] = 3;
    table[EVMC_FRONTIER][OP_MLOAD32] = 3;
    table[EVMC_FRONTIER][OP_MLOAD64] = 3;
    table[EVMC_FRONTIER][OP_CLOAD] = 3;
    table[EVMC_FRONTIER][OP_MSTORE] = 3;
    table[EVMC_FRONTIER][OP_MSTORE8] = 3;
    table[EVMC_FRONTIER][OP_MSTORE16] = 3;
    table[EVMC_FRONTIER][OP_MSTORE32] = 3;
    table[EVMC_FRONTIER][OP_MSTORE64] = 3;
...
constexpr inline std::array<Traits, 256> traits = []() noexcept {
    ...
    table[OP_MLOAD8] = {"MLOAD8", 0, false, 1, 0, EVMC_FRONTIER};
    table[OP_MLOAD16] = {"MLOAD16", 0, false, 1, 0, EVMC_FRONTIER};
    table[OP_MLOAD32] = {"MLOAD32", 0, false, 1, 0, EVMC_FRONTIER};
    table[OP_MLOAD64] = {"MLOAD64", 0, false, 1, 0, EVMC_FRONTIER};
    table[OP_CLOAD] = {"CLOAD", 0, false, 1, 0, EVMC_FRONTIER};
    table[OP_MSTORE] = {"MSTORE", 0, false, 2, -2, EVMC_FRONTIER};
    table[OP_MSTORE8] = {"MSTORE8", 0, false, 2, -2, EVMC_FRONTIER};
    table[OP_MSTORE16] = {"MSTORE16", 0, false, 2, -2, EVMC_FRONTIER};
    table[OP_MSTORE32] = {"MSTORE32", 0, false, 2, -2, EVMC_FRONTIER};
    table[OP_MSTORE64] = {"MSTORE64", 0, false, 2, -2, EVMC_FRONTIER};
    ...
    table[OP_PRINTF] = {"PRINTF", 0, false, 0, 0, EVMC_FRONTIER};
