    ...
    int64_t& gas_left, uint8_t* out_ptr, size_t val_idx, size_t num_vals) noexcept
{
    ...
    return active_mod->second->loadx(out_ptr, val_idx, num_vals) ? EVMC_SUCCESS : EVMC_FAILURE;
}
    ...
    int64_t& gas_left, const uint8_t* in_ptr, size_t dst_val_idx, size_t num_vals) noexcept
{
    ...
    return active_mod->second->storex(in_ptr, dst_val_idx, num_vals) ? EVMC_SUCCESS : EVMC_FAILURE;
}
    ...
    int64_t& gas_left, size_t dst_idx, size_t x_idx, size_t y_idx) noexcept
{
    ...
    return active_mod->second->addmodx(dst_idx, x_idx, y_idx) ? EVMC_SUCCESS : EVMC_FAILURE;
}
    ...
    int64_t& gas_left, size_t dst_idx, size_t x_idx, size_t y_idx) noexcept
{
    ...
    return active_mod->second->submodx(dst_idx, x_idx, y_idx) ? EVMC_SUCCESS : EVMC_FAILURE;
}
    ...
    int64_t& gas_left, size_t dst_idx, size_t x_idx, size_t y_idx) noexcept
{
    ...
    return active_mod->second->mulmodx(dst_idx, x_idx, y_idx) ? EVMC_SUCCESS : EVMC_FAILURE;
}
