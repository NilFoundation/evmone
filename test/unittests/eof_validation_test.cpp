...
TEST(eof_validation, EOF1_section_order)
{
    ...
    // 01 02 03 04
    EXPECT_EQ(
        validate_eof("EF0001 010004 0200010006 0300010001 040002 00 00800001 6000E0000000 FE AABB"),
        EOFValidationError::success);

    // 03 01 02 04
    EXPECT_EQ(
        validate_eof("EF0001 0300010001 010004 0200010006 040002 00 FE 00800001 6000E0000000 AABB"),
        EOFValidationError::type_section_missing);

    // 01 03 02 04
    EXPECT_EQ(
        validate_eof("EF0001 010004 0300010001 0200010006 040002 00 00800001 FE 6000E0000000 AABB"),
        EOFValidationError::code_section_missing);

    // 01 02 04 03
    EXPECT_EQ(
        validate_eof("EF0001 010004 0200010006 040002 0300010001 00 00800001 6000E0000000 AABB FE"),
        EOFValidationError::header_terminator_missing);
}
...
TEST(eof_validation, EOF1_embedded_container)
{
    ...
    // with data section
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 0300010014 040002 00 00800001 6000E0000000 "
                           "EF000101000402000100010300000000000000FE AABB"),
        EOFValidationError::success);
