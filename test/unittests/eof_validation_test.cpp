...
TEST(eof_validation, minimal_valid_EOF1_multiple_code_sections)
{
    ...
    // with data section
    EXPECT_EQ(validate_eof("EF0001 010008 02000200040001 040001 00  00000000 00000000  E3000100 FE DA"),
        EOFValidationError::success);

    // non-void input and output types
    EXPECT_EQ(validate_eof("EF0001 010010 0200040005000500080002 040000 00 "
                           "00000001 01000001 00010003 02030003"
...
{
    const auto eof =
        "EF0001 010008 02000200040001 040000 00 0000000000000000 E30001FE FE"_hex;
...
TEST(eof_validation, EOF1_too_many_code_sections)
{
    ...
    const auto valid = "EF0001 011000" + bytecode{"020400"} + 0x400 * bytecode{"0004"} +
                       "040000 00" + 0x400 * bytecode{"00000000"} + code_sections_1024;
...
{
    EXPECT_EQ(validate_eof("EF0001 010008 02000200830001 040000 00 0000007F 7F7F007F" + 127 * bytecode{"5F"} + "E3000100 E4"),
        EOFValidationError::success);
    ...
    {
        auto code = bytecode{"EF0001 010008 020002000400FF 040000 00 0000007F 007F007F E3000100"} +
    ...
    {
        auto code = bytecode{"EF0001 010008 02000200830080 040000 00 0000007F 7F00007F"} + 127 * bytecode{"5F"} +  "E3000100" +
                    127 * OP_POP + OP_RETF;
...
{
    {
        auto code = bytecode{"EF0001 010008 02000200040BFE 040000 00 00000000 000003FF E3000100"} +
...
TEST(eof_validation, many_code_sections_1023)
{
    ...
    const auto code = "EF0001 010FFC 0203FF " + 1023 * bytecode{"0004"} + "040000 00" +
      1023 * bytecode{"00000000"} + code_sections_1023;
...
TEST(eof_validation, many_code_sections_1024)
{
    ...
    const auto code = "EF0001 011000 020400 " + 1024 * bytecode{"0004"} + "040000 00" +
      1024 * bytecode{"00000000"} + code_sections_1024;
